...
# Instructions for Memory Bank files

When editing files under `memory-bank/`:

- Keep content high-level and durable across refactors.
- Avoid copying large chunks of source code into these files.
- Prefer bullet lists and short sections that explain why design decisions were made.
- Make sure `activeContext.md` describes the *current* work and recently finished tasks.
- Make sure `progress.md` lists what is done, what is in progress, and any known issues.
